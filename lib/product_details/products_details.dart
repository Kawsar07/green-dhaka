                    ...
                    Positioned(
                      ...
                      top: 5,
                       child: Container(
                        ...
                        child: Center(child: 
                          Text('1',style: TextStyle(fontSize: 10,color: MyColor.whitish),)
                        ),
                      ),
                    )
                  ],
            ...
            color: MyColor.primary,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(getTotal().toString(),style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: MyColor.whitish),),
                ],
              ),
            ),
          ),
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return ListView(
                                  ...
                                  children: <Widget>[
                                    SizedBox(
                                      width: 400,
                                      child: Image.asset('assets/images/plants1.png',fit: BoxFit.cover,),
                                    )
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Text('$price' , style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold,color: MyColor.textColor)),
                              ],
                            ),
                            SizedBox(height: 15,),
                            Text("Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries",textAlign: TextAlign.justify,),
                            SizedBox(height: 50,),
                            Container(
                          child: Row(
